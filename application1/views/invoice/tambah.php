				...
				<form id="form-invoice">
					...
					<div class="row" style="margin-top:10px;">
						<div class="col-md-6">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" name="nama_pelayan" value="<?php echo $this->session->userdata('nama');?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<textarea class="form-control" name="catatan" style="height:150px;resize:none;"></textarea>
							</div>
						</div>
					</div>
					<!--Pelayanan-->
	...
	$.ajax({
		...
		success:function(result){
			...
			if(result.code == 0){
				...
				setTimeout(function(){
					location.href="<?php echo base_url();?>main/invoice/detailData?id="+result.last_id;
				},3000);
			}else{
