<table class="table table-bordered" id="tbl_listproduk">
	...
	<?php $c=0;foreach($listkatagori as $lk):?>
		...
		<?php 
			$sql_produk = '
				...
				FROM produk a
				WHERE a.jumlah > 0
				AND a.katagori = "'.$lk->kategoriproduk.'"
				ORDER BY a.nama ASC
			';
	...
	<tr>
		...
		<td class="text-center text-uppercase">
			<center>
				<input type="text" class="form-control" name="subttl_produk" value="0" style="width:120px;text-align: right;" readonly>
			</center>
		</td>
	</tr>
	<tr>
		...
		<td class="text-uppercase">
			<input type="number" class="form-control" name="diskon_persen" value="0" min="0" max="100" style="text-align: right;" onchange="hitDiskon();">
		</td>
		<td class="text-center text-uppercase">
			<center>
				<input type="text" class="form-control" name="diskon_amount" value="0" style="width:120px;text-align: right;" readonly>
			</center>
		</td>
	</tr>
	<tr>
		...
		<td class="text-center text-uppercase">
			<center>
				<input type="text" class="form-control" name="grandtotal_produk" value="0" style="width:120px;text-align: right;" readonly>
			</center>
		</td>
	</tr>
	</tbody>
