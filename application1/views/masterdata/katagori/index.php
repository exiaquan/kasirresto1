<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="col-md-12">
					<a class="btn btn-default" href="<?php echo base_url();?>main/masterdata/katagoribarang/tambah">Tambah</a>
				</div>
							...
							<tbody>
								<?php foreach($satuan as $s):?>
									<tr>
										...
										<td class="text-center">
											<a class="btn btn-danger" href="./katagoribarang/hapusData?id=<?php echo $s->id;?>"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php endforeach;?>
							</tbody>
